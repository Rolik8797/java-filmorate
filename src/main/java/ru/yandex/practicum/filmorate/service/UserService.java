...
public class UserService {
    ...
    public Collection<User> getAllUsers() {
        try {
            ...
            throw new RuntimeException("Возникла проблема при получении списка пользователей", e);
        }
    }
    ...
    public User add(final User user) {
        try {
            ...
            // Обработка ошибки: возникла проблема при добавлении пользователя
            throw new RuntimeException("Возникла проблема при добавлении пользователя", e);
        }
    }
    ...
    public User getUser(final String supposedId) {
        try {
            ...
            // Обработка ошибки: пользователь не найден
            throw new NotFoundException("Пользователь не найдлен");
        }
    }
